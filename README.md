...
- 🔥 [Burn 451](https://github.com/Fisher521/killmybookmark/tree/main/mcp-server) - Personal reading knowledge base with 22 tools. Triage bookmarks (Flame/Spark/Vault/Ash lifecycle), search saved articles, and create collections. Available on [npm](https://www.npmjs.com/package/burn-mcp-server).
