...
- [Burn MCP Server](https://github.com/Fisher521/burn-mcp-server) - AI-powered reading triage MCP server with 26 tools. Save articles with a 24h burn timer, AI digest, flame/spark/vault lifecycle, and curated knowledge vaults. Install: `npx burn-mcp-server`
