...
- <img src="https://www.burn451.cloud/favicon.ico" height="14"/> [Burn 451](https://github.com/Fisher521/burn-mcp-server) - Personal reading vault as an AI-accessible knowledge base. 26 tools to search, triage, and organize read-later bookmarks; works with Claude, Cursor, and Windsurf via `npx burn-mcp-server`.
